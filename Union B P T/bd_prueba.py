...
def crearbd():
    ...
    INSERT INTO Usuarios (ID_usuario, name, email, password) VALUES (?, ?, ?, ?)''', [
        (1, 'Esban', 'Itan.daniel.fr@gmail.com', '123'),
    ])

    cursor.executemany('''
    INSERT INTO Cuentas_de_banco (ID_cuentabanco, ID_usuario, banco) VALUES (?, ?, ?)''', [
        (1, 1,'Santander'),
    ])

    cursor.executemany('''
    INSERT INTO Categoria (ID_categoria, ID_cuentabanco, nombre) VALUES (?, ?, ?)''', [
        (1, 1,'Vacaciones'),
    ])
